...
import org.ifinalframework.plugins.aio.javadoc.JvmDocCompletionProvider
 ...
 * @since 0.0.24
 */
class JvmTaskDocCompletionProvider : JvmDocCompletionProvider {
    ...
    override fun addDocTagCompletions(
        parameters: CompletionParameters,
        context: ProcessingContext,
        result: CompletionResultSet
    ) {
    ...
    override fun addEndOfLineCommentCompletions(
        parameters: CompletionParameters,
        context: ProcessingContext,
        result: CompletionResultSet
    ) {
        addEndOfLineCommentCompletions(parameters, context, result)
    }
}